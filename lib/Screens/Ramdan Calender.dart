                                    ...
                                    child: Align(
                                      ...
                                      child: ListView.builder(
                                          ...
                                          itemBuilder: (BuildContext context,
                                              int index) {
                                            String sehr = snapshot.data!
                                                .data![index].timings!.fajr
                                                .toString()
                                                .split(" ")[0]
                                                .toString()
                                                .replaceAll(
                                                    RegExp(r'^0+(?=.)'), '');
                                            String iftaar = snapshot.data!
                                                .data![index].timings!.sunset
                                                .toString()
                                                .split("(")[0]
                                                .trim();
                                            ...
                                            String weekInThreeChar = weeks[0] +
                                                weeks[1] +
                                                weeks[2]; // Sun ,Mon

                                            var months =
                                                monthStr.split(""); // April
                                            ...
                                            int roza = int.parse(snapshot.data!
                                                .data![index].date!.hijri!.day
                                                .toString());

                                            String? fullDate = snapshot
                                                .data!
                                                .data![index]
                                                .date!
                                                .gregorian!
                                                                    ...
                                                                    mon == current_month &&
                                                                        ...
                                                                        ? Row(
                                                                            ...
                                                                            children: [
                                                                              ...
                                                                              TextWidget(name: (snapshot.data!.data![index].date!.hijri!.day).toString()),
                                                                              SizedBox(
                                                                                width: 5,
                                                                              ),
                                                                              TextWidget(name: weekInThreeChar),
                                                                              TextWidget(name: fullDate),
                                                                              TextWidget(name: sehr + " am "),
                                                                              TextWidget(name: ifttime + " pm "),
                                                                              SizedBox(
                                                                                width: 2,
                                                                              ),
                                                                            ],
                                                                        ...
                                                                        : Row(
                                                                            ...
                                                                            children: [
                                                                              ...
                                                                              CurrentRoza(name: (snapshot.data!.data![index].date!.hijri!.day).toString()),
                                                                              SizedBox(
                                                                                width: 5,
                                                                              ),
                                                                              CurrentRoza(name: weekInThreeChar.toString()),
                                                                              CurrentRoza(name: fullDate),
                                                                              CurrentRoza(name: sehr + " am "),
                                                                              CurrentRoza(name: ifttime + " pm "),
                                                                              SizedBox(
                                                                                width: 2,
                                                                              ),
                                                                            ],
